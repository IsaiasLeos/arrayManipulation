...
/**
 * Objective - To determine if an array of integers in a certain range contains duplicate elements. 
...
public class Lab2
{
	...
	public static int[] randomArray(int size, int range)//O(N)
	{
		...
		for(int i = 0; i < generatedArray.length; i++)//populate array with random numbers
		{
	 ...
	 * @param randomIntArray generated array with random numbers at the range of m - 1
	 * @return
	 */
	...
	/**
	 * A sorting algorithm that sorts an array by repeatedly finding the minimum element from unsorted part
	...
	/**
	 * Uses a boolean array to check if the provided array has any duplicate numbers.
